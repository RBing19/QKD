...
eta_AE_values = np.linspace(0.00001, 0.002, 200)
...
for eta_AE in eta_AE_values:
    ...
    #my method
    R_opt21 =key_rate(mu1, eta_AE,v11,v21)
    key_rate_values1.append(R_opt21)
    R_opt22 = key_rate(mu1, eta_AE, v12, v22)
    key_rate_values2.append(R_opt22)
    R_opt23 = key_rate(mu1, eta_AE, v13, v23)
...
ax1.semilogy(eta_AE_values, R_wcp_values1, 'k--', label='reference[36]', linewidth=2)
ax1.semilogy(eta_AE_values, key_rate_values1, 'r-', label='our method,v1=0.1,v2=0.2', linewidth=2)
ax1.semilogy(eta_AE_values, key_rate_values2, 'c-', label='our method,v1=0.01,v2=0.02', linewidth=2)
ax1.semilogy(eta_AE_values, key_rate_values3, 'b-', label='our method,v1=0.001,v2=0.002', linewidth=2)
